...
class Character:
    ...
    def heal(self):
        ...
        new_health = min(self.health + heal_amount, self.max_health)
        healed_amount = new_health - self.health
        self.health = new_health
        print(f"{self.name} heals for {healed_amount} points! Current health: {self.health}/{self.max_health}")
...
class Warrior(Character):
    ...
    def special_ability(self, opponent):
        ...
        print(
            f"Uses Burning Maul on {opponent.name} for {self.attack_power * 2}")
...
class Mage(Character):
    ...
    def special_ability(self, opponent):
        opponent.health -= self.attack_power * 2
        print(
            f"Uses Holy on {opponent.name} for {self.attack_power * 2} damage!")
